...
extension SearchViewController: UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configure(with: TitleViewModel(titleName: title.original_title ?? "Unknown title",
                                            posterURL: title.poster_path ?? "Unknown posterpath"))
        return cell
    }
        ...
        APICaller.shared.getMovie(with: titleName) { [weak self] result in
            ...
            case .success(let videoElement):
                DispatchQueue.main.async {
                    ...
                    vc.configure(with: TitlePreviewViewModel(title: titleName, youtubeView: videoElement, titleOverview: title.overview ?? "This movie don't have overview"))
